package com.radinfodesign.radspringbootgen.fboace.controller;
/*
...
import com.radinfodesign.radspringbootgen.fboace.service.FlightService;
import com.radinfodesign.radspringbootgen.fboace.service.PilotService;
import com.radinfodesign.radspringbootgen.fboace.service.AircraftService;
import com.radinfodesign.radspringbootgen.fboace.service.AirportService;
...
public class FlightWebController {
                                       ...
                                       ) 
  {
    ...
    request.setAttribute(MSG, message);
    Flight entity = service.getEntity(flightId);
    model.addAttribute(INSTANCE, entity);
    request.setAttribute(ENTITY_ATT_ID, entity.getFlightId());
    request.setAttribute(RedirectView.RESPONSE_STATUS_ATTRIBUTE, HttpStatus.TEMPORARY_REDIRECT);
    return "forward:"+ENTITY_URL+ENTITY_EDIT_URL;

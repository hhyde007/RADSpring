...
public class FlightServiceImpl implements FlightService{
       ...
       ) throws Exception
  {
    ...
    flight.setAircraftId(aircraftRepository.findOne(aircraftId));
    flight.setAirportIdDeparture(airportRepository.findOne(airportIdDeparture));
    flight.setAirportIdDestination(airportRepository.findOne(airportIdDestination));

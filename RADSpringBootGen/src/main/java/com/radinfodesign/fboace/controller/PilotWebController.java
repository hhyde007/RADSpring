...
public class PilotWebController {
  ...
  public static final String ENTITY_ATTRIB_PILOTRARETHING_SHORT_NAME="pilotRareThingShortName";  
  public static final String ENTITY_ATTRIB_PILOTRARETHING_LONG_NAME="pilotRareThingLongName";  
  public static final String ENTITY_ATTRIB_PILOTRARETHING_NOTES="pilotRareThingNotes";  
...
//      model.addAttribute(ENTITY_ATTRIB_AIRCRAFTTYPES, aircraftTypeService.getQualifiedAircraftTypesByPilotId(entity.getPilotId()));
  ...
  public String putEntity ( @RequestParam(name=ENTITY_ATT_ID, defaultValue="0") Integer pilotId
                          ...
                          , @RequestParam(name=ENTITY_ATTRIB_PILOTRARETHING_SHORT_NAME, required=false) String[] pilotRareThingShortNames 
                          , @RequestParam(name=ENTITY_ATTRIB_PILOTRARETHING_LONG_NAME, required=false) String[] pilotRareThingLongNames 
                          , @RequestParam(name=ENTITY_ATTRIB_PILOTRARETHING_NOTES, required=false) String[] pilotRareThingNotess 
                          , Model model
                          , HttpServletRequest request
                          )
  {
    ...
    try {
      Pilot entity = service.putEntity( pilotId
                                         ...
                                         , pilotRareThingShortNames
                                         , pilotRareThingLongNames
                                         , pilotRareThingNotess
                                         );
      message = "Pilot saved.";
  ...
  @PostMapping(value = "/DeletePilotRareThing")
  public String deletePilotRareThing ( @RequestParam(name="pilotId") Integer pilotRareThingPilotId
                                     , Model model
                                     , HttpServletRequest request
                                     ) 
  {
    out.println("");
    String message = null;
    int deleteResult = service.deletePilotRareThing (pilotRareThingPilotId); 
    
    if (deleteResult == 1) { 
      message = "Pilot Rare Thing record deleted.";  
    }
    else 
    {
      message = "Pilot Rare Thing deletion failed.";  
    }
    request.setAttribute(MSG, message);
    Pilot entity = service.getEntity(pilotRareThingPilotId);
    //entity.setPilotRareThing(pilotRareThingRepository.findOne(pilotRareThingPilotId));
    model.addAttribute(INSTANCE, entity);
    request.setAttribute(ENTITY_ATT_ID, entity.getPilotId());
    request.setAttribute(RedirectView.RESPONSE_STATUS_ATTRIBUTE, HttpStatus.TEMPORARY_REDIRECT);
    return "forward:"+ENTITY_URL+ENTITY_EDIT_URL;
